<template>
  <div class="location-widget container mx-auto bg-blue-300 p-10 rounded-b-xl lg:rounded-xl text-black text-center ">
    <h2>Your Location</h2>
    ...
    <button @click="fetchLocationDetails" class="text-black">Find Location Details</button>

    <div v-if="foundLocation">
      <h3 class="text-black">Location Details</h3>
